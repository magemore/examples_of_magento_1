...
abstract class Magemore_Tragento_Block_Adminhtml_Magento_Product_Grid_Abstract
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $advancedFilterBlock = $this->getLayout()->createBlock('tragento/adminhtml_listing_product_rule');
